...
///
/// # ***IMPORTANT:***
/// Calling .`close()` will drop the underlying file handle. This will cause ***`deref`*** from [`Deref`](Deref) and ***`deref_mut`*** from [`DerefMut`](DerefMut) to **panic**. Be ***EXTREMELY*** careful with .`close()`.
pub struct TempFile {
